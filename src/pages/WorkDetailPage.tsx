...
export default function WorkDetailPage() {
  ...
  useEffect(() => {
    console.log('[WorkDetailPage] Loading work with id:', id);
    if (!id) {
      console.warn('[WorkDetailPage] No work ID provided');
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      console.log('[WorkDetailPage] Work data found:', data ? 'yes' : 'no', 'for id:', id);
      if (data) {
      ...
      console.error('[WorkDetailPage] Failed to load work:', error);
      setWork(null);
    } finally {
      setLoading(false);
    }
